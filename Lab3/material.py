...
negro = Material(diffuse=color(0, 0, 0), albedo=(0.5, 0.5, 0, 0), spec=15)
nieve = Material(diffuse=color(255, 255, 255), albedo=(0.4, 0.4, 0, 0), spec=14)
pupila = Material(diffuse=color(155, 155, 155), albedo=(0.3, 0.3, 0, 0), spec=13)
nariz = Material(diffuse=color(239, 127, 26), albedo=(0.2, 0.2, 0, 0), spec=12)
